...
$editFormAction = $_SERVER['PHP_SELF'];
	...
	$RecordsetBssn = mysqli_query($admin_buy_local, $query_RecordsetBssn) or die(mysqli_error());

	$row_RecordsetBssn = mysqli_fetch_assoc($RecordsetBssn);

	$totalRows_RecordsetBssn = mysqli_num_rows($RecordsetBssn);
